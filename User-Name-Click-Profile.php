...
<?php
	...
	$login_position = $_SESSION['position'];
	$user_id = $_SESSION['user_id'];

	$list_user_id = $_SERVER["QUERY_STRING"];

	//自分の名前をクリックすると
	if($list_user_id == $user_id){
		echo "<script>location.href='./Profile-Account.php'</script>";
	}
	...
	$sql = "SELECT * FROM USER WHERE USER_ID = '$list_user_id'";
         ...
         <div class="container-xl">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(./static/user/<?php echo $user_image ?>)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div><?php echo $login_name ?></div>
                  <div class="mt-1 small text-muted"><?php echo $login_position ?></div>
                </div>
              </a>
							...
							<div class="card-body p-4 text-center">
								...
								<div class="card-profile-stats d-flex justify-content-center">
									...
									<div>
										...
										<span class="description"><?php echo $position ?></span>
									</div>
								</div>
						...
						<div class="card-body">
							<form method="POST" action="./userup.php">
								...
								<div class="pl-lg-4">
									<div class="row">
										<div class="col-lg-6">
											<div class="form-label">
												...
												<input type="text" name = "username" id="input-username" class="form-control" value="<?php echo $name ?>" disabled="disabled" >
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-label">
									...
									<div class="col-lg-6">
										<div class="form-label">
											...
											<input type="text" name="tel" class="form-control" data-mask="(000) 0000-0000" data-mask-visible="true" autocomplete="off" value="<?php echo $tel ?>" disabled="disabled"/>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-label">
											<label class="form-control-label" for="input-last-name">Position</label>
											<input type="text" name = "position" id="input-last-name" class="form-control" value="<?php echo $position ?>" disabled="disabled">
										</div>
									</div>
									</div>
								</div>
								...
								<div class="pl-lg-4">
									...
									<div class="col-md-12">
										<div class="form-label">
											...
											<input id="input-address" name = "address" class="form-control" placeholder="Home Address" value="<?php echo $address ?>" type="text" disabled="disabled">
										</div>
									</div>
									</div>
									<div class="row">
									<div class="col-lg-4">
										<div class="form-label">
											...
											<select name="city" class="form-select" disabled="disabled">
									...
									<div class="col-lg-4">
										<div class="form-label">
											...
											<select name="country" class="form-select" disabled="disabled">
												<option value="" selected disabled hidden><?php echo $country2 ?></option>
									...
									<div class="col-lg-4">
										<div class="form-label">
											...
											<select name="department" class="form-select" disabled="disabled">
								...
								<h6 class="card-title">About me</h6>
									<div class="pl-lg-4">
										<div class="form-label">
											<textarea rows="4" class="form-control" name="about" placeholder="A few words about you ..." disabled="disabled"><?php echo addslashes($about) ?></textarea>
										</div>
									</div>
